                ...
                <table>
                    ...
                    <?php $__currentLoopData = $movie; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($movies->genre_id == $genres->id): ?>
                            ...
                            <a href="<?php echo e(url('/', [$movies->movie_title])); ?>"><img src="<?php echo e($movies->photo); ?>" alt="" width="250" height="370" style="overflow-x: auto;"> </a> 
                                <br>   
...
</html><?php /**PATH E:\LaravelInstall\uts\resources\views/home.blade.php ENDPATH**/ ?>